...
data <- read.csv("F:/Brand New Thesis/Srijon/GSE16515.csv", row.names=1)
...
for (i in 1:nrow(data)){
  vec1 = as.numeric(data[i:i,1:16])
  vec2 = as.numeric(data[i:i,17:52])
  # print(i)
  #print(vec1)
  #vec2
...
write.csv(res, file="F:/Brand New Thesis/Srijon/GSE16515-Adjusted-Pvals-All-Methods-Wilcoxon-log.csv")
