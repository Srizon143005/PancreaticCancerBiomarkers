...
data <- read.csv("F:/Brand New Thesis/Srijon/GSE15471.csv", row.names=1)
...
write.csv(res, file="F:/Brand New Thesis/Srijon/GSE15471-Adjusted-Pvals-All-Methods-T-Test.csv")
