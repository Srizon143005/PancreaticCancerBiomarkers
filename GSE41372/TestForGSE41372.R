...
data <- read.csv("F:/Brand New Thesis/Srijon/GSE41372.csv", row.names=1)
...
write.csv(res, file="F:/Brand New Thesis/Srijon/GSE41372-Adjusted-Pvals-All-Methods-Wilcoxon.csv")
