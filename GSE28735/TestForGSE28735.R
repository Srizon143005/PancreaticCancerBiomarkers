...
data <- read.csv("F:/Brand New Thesis/Srijon/GSE28735.csv", row.names=1)
...
for (i in 1:nrow(data)){
  vec1 = as.numeric(data[i:i,1:45])
  vec2 = as.numeric(data[i:i,46:90])
  # print(i)
  #print(vec1)
  #vec2
...
write.csv(res, file="F:/Brand New Thesis/Srijon/GSE28735-Adjusted-Pvals-All-Methods-Wilcoxon.csv")
